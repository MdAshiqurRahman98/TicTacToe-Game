...
def CheckWinner():
    ...
    if winner ==1:
        ...
        messagebox.showinfo(title="Draw", message="Draw the Game!")
...
root.title("Tic Tac toe : Player 1")
st = ttk.Style()
st.configure("my.TButton", background="green", font=('Chiller',24,'bold'))
...
Button(text="New Game...", font=('Courier new', 22, 'bold'), bg='green', fg='white', border=5, width=4,command = lambda :Restart()).grid(row=0, column=1, sticky="we")
root.resizable(0, 0)
root.mainloop()